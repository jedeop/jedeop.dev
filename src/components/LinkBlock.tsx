...
export default function LinkBlock({ content }: LinkBlockProps) {
  const body = (
    <div
      className={`flex items-center gap-2 py-1.5 px-5 rounded-full border-3 border-gray-200 dark:border-gray-700 ${content.life ? "border-dashed" : "bg-gray-200 dark:bg-gray-700"}`}
    >
